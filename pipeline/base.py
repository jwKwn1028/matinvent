...
class ReinL:
    ...
    def reward_step(
        ...
        logging.info(
            f"Number of samples that successfully obtained rewards: {len(success_struc)}"
        )
        if len(success_rewards):
            logging.info(
            ...
            logging.warning("No generated structure received a valid reward.")
